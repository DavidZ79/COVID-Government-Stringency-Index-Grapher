...
if __name__ == '__main__':
    ...
    python_ta.check_all(config={
        'extra-imports': ['pandas', 'BackEnd.country_data'],  # the names (strs) of imported modules
        'allowed-io': ['load_files'],  # the names (strs) of functions that call print/open/input
        'max-line-length': 100,
        'disable': ['R1705', 'C0200']
    })
