...
if __name__ == '__main__':
    ...
    listbox = tk.Listbox(scroll_frame, width=30, height=50, yscrollcommand=scrollbar.set,
    ...
    drop_policy.config(width=20, bg="blue", fg="white")
    ...
    drop_category.config(width=20, bg="blue", fg="white")
